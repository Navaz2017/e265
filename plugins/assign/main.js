...
define(templates, function (assignTpl, submissionsTpl) {
    var plugin = {
         ...
         * It may check e263 remote site version, device OS, device type, etc...
        ...
        _downloadFile: function(url, filename, attachmentId) {
            ...
            MM.fs.init(function() {
                if (MM.deviceConnected()) {
                    MM.log("Starting download of e263 file: " + downloadURL);
                    // All the functions are asynchronous, like createDir.
                    MM.fs.createDir(directory, function() {
                        MM.log("Downloading e263 file to " + filePath + " from URL: " + downloadURL);
